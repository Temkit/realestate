...
export async function generateMetadata({
  ...
  const fr = locale === "fr";
  return {
    title: fr ? "Questions fréquentes | lëtz24" : "FAQ | lëtz24",
    description: fr
      ? "Comment fonctionne lëtz24, est-ce gratuit, comment recevoir des devis et prendre rendez-vous."
      : "How lëtz24 works, is it free, how to get quotes and book appointments.",
...
const FAQ = {
  fr: [
    ["Qu'est-ce que lëtz24 ?", "lëtz24 est une plateforme qui vous met en relation avec des prestataires de services au Luxembourg : garages, artisans, coiffeurs, déménagement, beauté et plus. Comparez, demandez des devis et prenez rendez-vous en un endroit."],
    ["Est-ce gratuit pour moi ?", "Oui, l'utilisation de lëtz24 est entièrement gratuite et sans engagement pour les particuliers."],
  ...
  en: [
    ["What is lëtz24?", "lëtz24 connects you with service providers in Luxembourg: garages, tradespeople, hairdressers, movers, beauty and more. Compare, request quotes and book — all in one place."],
    ["Is it free for me?", "Yes, using lëtz24 is completely free and no-obligation for individuals."],
