...
export function FilterBar({ properties, onFilteredChange }: FilterBarProps) {
  ...
  return (
    <div className="mb-6">
      ...
      <button
        ...
        className="sm:hidden flex items-center gap-2 text-sm font-medium text-muted-foreground hover:text-foreground
                   transition-colors px-3.5 py-2.5 rounded-xl border mb-3"
      >
      ...
      {/* Filter chips */}
      <div
        className={`flex flex-wrap gap-2.5 ${expanded ? "flex" : "hidden sm:flex"}`}
      >
        {/* Price range */}
